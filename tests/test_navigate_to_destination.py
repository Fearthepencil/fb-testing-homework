...
def test_navigate_to_destination(page, test_config: dict):
    ...
    first_destination = page.locator(
        sitemap_page.FIRST_DESTINATION_LINK_SELECTOR
    ).first
    ...
    assert test_config["urls"]["destination_url"] in page.url, "Destination page did not load"
